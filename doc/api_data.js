define({ "api": [
  ...
  {
    "type": "get",
    "url": "/{clientId}/finishedDestinations",
    "title": "Get All Finished Destinations",
    "version": "1.0.0",
    "name": "Get_All_Finished_Destinations",
    "group": "Client",
    "description": "<p>Client get all finished destinations - get only finished destinations</p>",
    "parameter": {
      "fields": {
        "path": [
          {
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "destinations",
            "description": "<p>Destinations array [ { &quot;_id&quot;: &quot;a-d.x-;s-39;x-s9-3la-fl2&quot;, &quot;firstName&quot;: &quot;Driver&quot;, &quot;lastName&quot;: &quot;One&quot;, &quot;email&quot; : &quot;driverone@gmail.com&quot;, &quot;phone&quot;: &quot;0600123456&quot;, &quot;address&quot;: &quot;St. Joseph's Boulevard 50&quot; }, { &quot;_id&quot;: &quot;a-d.x-;flow1-s9-3la-aswsq&quot;, &quot;firstName&quot;: &quot;Driver&quot;, &quot;lastName&quot;: &quot;Two&quot;, &quot;email&quot; : &quot;drivertwo@gmail.com&quot;, &quot;phone&quot;: &quot;0600234567&quot;, &quot;address&quot;: &quot;St. Joseph's Boulevard 50&quot; } ]</p>"
          }
        ]
      }
    },
  ...
  {
    "type": "get",
    "url": "/{clientId}/destinationRequests/{destinationId}",
    "title": "Get All Requests For Destination",
    "version": "1.0.0",
    "name": "Get_All_Requests_For_Destination",
    "group": "Client",
    "description": "<p>Client get all requests for destination - get all requests for destination</p>",
    "parameter": {
      "fields": {
        "path": [
          {
      ...
      "fields": {
        ...
        "body": [
          ...
          },
          {
            ...
            "type": "Number",
            "optional": true,
            "field": "requestPerKmPrice",
            "description": "<p>Destination price per km</p>"
          }
        ]
      }
    },
  ...
  {
    "type": "get",
    "url": "/{managerId}/vehicles/{vehicleId}",
    "title": "Find Vehicle By Id",
    "version": "1.0.0",
    "name": "Find_Vehicle_By_Id",
    "group": "Manager",
    "description": "<p>Manager find vehicle - find vehicle by id</p>",
    "parameter": {
      "fields": {
        "path": [
          {
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "Vehicle",
            "description": "<p>Found vehicle { &quot;_id&quot;: &quot;a-d.x-;s-39;x-s9-3la-fl2&quot;, &quot;name&quot;: &quot;First bus&quot;, &quot;model&quot;: &quot;Mercedes-Benz do Brasil&quot;, &quot;licensePlate&quot; : &quot;NS-123-AD&quot;, &quot;licenseExpireDate&quot;: &quot;2019-10-21&quot;, &quot;numberOfSeats&quot;: &quot;50&quot;, &quot;productionYear&quot;: &quot;2015&quot;, &quot;numberOfKmPassed&quot;: &quot;50000&quot; }</p>"
          }
        ]
      }
    },
  ...
  {
    "type": "get",
    "url": "/{managerId}/drivers/{driverId}",
    "title": "Get Driver By Id",
    "version": "1.0.0",
    "name": "Get_Driver_By_Id",
    "group": "Manager",
    "description": "<p>Manager get driver - get driver by id</p>",
    "parameter": {
      "fields": {
        "path": [
          {
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "Driver",
            "description": "<p>Found driver { &quot;_id&quot;: &quot;a-d.x-;s-39;x-s9-3la-fl2&quot;, &quot;firstName&quot;: &quot;Driver&quot;, &quot;lastName&quot;: &quot;One&quot;, &quot;email&quot; : &quot;driverone@gmail.com&quot;, &quot;phone&quot;: &quot;0600123456&quot;, &quot;address&quot;: &quot;St. Joseph's Boulevard 50&quot; }</p>"
          }
        ]
      }
    },
  ...
  {
    "type": "post",
    "url": "/{managerId}/sendNotification",
    "title": "Send Push Notification To User",
    "version": "1.0.0",
    "name": "Send_Push_Notification_To_User",
    "group": "Manager",
    "description": "<p>Manager send push notification to user - send notification to user about his request</p>",
    "parameter": {
      "fields": {
        "path": [
          {
        ...
        "body": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "requestId",
            "description": "<p>DestinationRequestId</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "request",
            "description": "<p>DestinationRequest [ { &quot;_id&quot;: &quot;a-d.x-;s-39;x-s9-3la-fl2&quot;, &quot;firstName&quot;: &quot;Driver&quot;, &quot;lastName&quot;: &quot;One&quot;, &quot;email&quot; : &quot;driverone@gmail.com&quot;, &quot;phone&quot;: &quot;0600123456&quot;, &quot;address&quot;: &quot;St. Joseph's Boulevard 50&quot; } ]</p>"
          }
        ]
      }
    },
        ...
        "body": [
          {
            ...
            "optional": false,
            "field": "startDate",
            "description": "<p>DestinationRequest start date</p>"
          },
          {
            "group": "body",
            "type": "Date",
            "optional": false,
            "field": "endDate",
            "description": "<p>DestinationRequest end date</p>"
          },
          {
            "group": "body",
            "type": "Number",
            "optional": false,
            "field": "price",
            "description": "<p>DestinationRequest price</p>"
          },
          {
            "group": "body",
            "type": "Number",
            ...
            "description": "<p>DestinationRequest destinationOrder</p>"
          },
          {
            "group": "body",
            "type": "Number",
            "optional": false,
            "field": "destinationId",
            "description": "<p>DestinationRequest destinationId</p>"
          },
          {
            "group": "body",
            "type": "Number",
            "optional": false,
            "field": "distance",
            "description": "<p>DestinationRequest distance</p>"
          },
          {
            "group": "body",
            "type": "Number",
            "optional": true,
            "field": "discount",
            "description": "<p>DestinationRequest price discount</p>"
          }
        ]
      }
    },
  ...
  {
    "type": "post",
    "url": "/{managerId}/destinations/{destinationId}/updateRequests",
    "title": "Update Requests For Destination",
    "version": "1.0.0",
    "name": "Update_Requests_For_Destination",
    "group": "Manager",
    "description": "<p>Manager update requests for destination - change statuses</p>",
    "parameter": {
      "fields": {
        "path": [
          {
        ...
        "body": [
          {
            ...
            "description": "<p>Requests before any change</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "requests",
            "description": "<p>DestinationRequests [ { &quot;_id&quot;: &quot;a-d.x-;s-39;x-s9-3la-fl2&quot;, &quot;firstName&quot;: &quot;Driver&quot;, &quot;lastName&quot;: &quot;One&quot;, &quot;email&quot; : &quot;driverone@gmail.com&quot;, &quot;phone&quot;: &quot;0600123456&quot;, &quot;address&quot;: &quot;St. Joseph's Boulevard 50&quot; } ]</p>"
          }
        ]
      }
    },
  ...
  {
    "type": "put",
    "url": "/{userId}/requests/{destinationRequestId}/accept",
    "title": "User Accept Request",
    "version": "1.0.0",
    "name": "User_Accept_Request",
    "group": "User",
    "description": "<p>User accept request - accept user request</p>",
    "parameter": {
      "fields": {
        "path": [
          {
  ...
  {
    "type": "put",
    "url": "/{userId}/requests/{destinationRequestId}/reject",
    "title": "User Reject Request",
    "version": "1.0.0",
    "name": "User_Reject_Request",
    "group": "User",
    "description": "<p>User reject request - reject user request</p>",
    "parameter": {
      "fields": {
        "path": [
          {
  ...
  },
  {
    ...
    "group": "User",
    "description": "<p>User update info - update personal info</p>",
    "parameter": {
      "fields": {
        "path": [
          {
